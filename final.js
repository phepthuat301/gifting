...
function reveal() {
  ...
  video.setAttribute("controls", true); // Optional, for play/pause controls
  video.style.border = 'none';

  // Set the source for the video
  var source = document.createElement("source");
  source.setAttribute("src", "IMG_4011.mp4"); // Path to your .mov file
  source.setAttribute("type", "video/mp4"); // Adjust type based on your video format
